...
async function getAppPageStaticInfo({ pageFilePath, nextConfig, isDev, page }) {
    ...
    if ((_nextConfig_experimental = nextConfig.experimental) == null ? void 0 : _nextConfig_experimental.dynamicIO) {
        ...
        unsupportedSegmentConfigs = unsupportedSegments.filter((prop)=>typeof config[prop] !== 'undefined').sort();
    }
