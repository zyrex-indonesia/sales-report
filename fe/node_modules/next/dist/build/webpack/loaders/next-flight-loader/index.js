...
const isSharedRuntime = (0, _picomatch.default)('**/next/dist/**/*.shared-runtime.js', {
    dot: true
});
    ...
    if (((_buildInfo_rsc = buildInfo.rsc) == null ? void 0 : _buildInfo_rsc.type) === _constants1.RSC_MODULE_TYPES.client) {
        ...
        if (assumedSourceType === 'module') {
            ...
            if (!isSharedRuntime(resourceKey)) {
                ...
                // manifest.
                this._compilation.moduleGraph.getExportsInfo(module1).setUsedInUnknownWay(isEdgeServer ? _constants1.EDGE_RUNTIME_WEBPACK : _constants1.DEFAULT_RUNTIME_WEBPACK);
            }
