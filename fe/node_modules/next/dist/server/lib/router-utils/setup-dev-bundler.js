...
async function startWatcher(opts) {
    ...
    await new Promise(async (resolve, reject)=>{
            ...
            for (const fileName of sortedKnownFiles){
                ...
                if (isAppPath) {
                    ...
                    if (nextConfig.experimental.dynamicIO) {
                        var _staticInfo_unsupportedSegmentConfigs;
                        const staticInfo = await (0, _entries.getStaticInfoIncludingLayouts)({
                            pageFilePath: fileName,
                            config: nextConfig,
                            appDir: appDir,
                        ...
                        if ('unsupportedSegmentConfigs' in staticInfo && ((_staticInfo_unsupportedSegmentConfigs = staticInfo.unsupportedSegmentConfigs) == null ? void 0 : _staticInfo_unsupportedSegmentConfigs.length)) {
                            pagesWithUnsupportedSegments.set(pageName, staticInfo.unsupportedSegmentConfigs);
                        }
                    }
         ...
         */ if (/[\\\\/]_middleware$/.test(pageName)) {
            ...
            if (nextConfig.experimental.dynamicIO) {
                const pagesWithIncompatibleSegmentConfigs = [];
                pagesWithUnsupportedSegments.forEach((unsupportedSegmentConfigs, page)=>{
                    if (unsupportedSegmentConfigs && unsupportedSegmentConfigs.length > 0) {
