...
const renderToHTMLOrFlight = (req, res, pagePath, query, fallbackRouteParams, renderOpts, serverComponentsHmrCache)=>{
    ...
    const requestStore = (0, _requeststore.createRequestStoreForRender)(req, res, url, implicitTags, renderOpts.onUpdateCookies, renderOpts.previewProps, isHmrRefresh, serverComponentsHmrCache);
...
async function spawnDynamicValidationInDev(resolveValidation, tree, ctx, isNotFound, clientReferenceManifest, route) {
    ...
    let serverDynamicTracking = (0, _dynamicrendering.createDynamicTrackingState)(false);
    ...
    const firstAttemptRSCPayload = await _workunitasyncstorageexternal.workUnitAsyncStorage.run(firstAttemptServerPrerenderStore, getRSCPayload, tree, ctx, isNotFound);
    let reactServerStream = await _workunitasyncstorageexternal.workUnitAsyncStorage.run(firstAttemptServerPrerenderStore, _apprenderrenderutils.scheduleInSequentialTasks, ()=>{
        const stream = ComponentMod.renderToReadableStream(firstAttemptRSCPayload, clientReferenceManifest.clientModules, {
    ...
    if (serverDynamicTracking.syncDynamicErrorWithStack) {
        ...
        serverDynamicTracking = (0, _dynamicrendering.createDynamicTrackingState)(false);
        ...
        const secondAttemptRSCPayload = await _workunitasyncstorageexternal.workUnitAsyncStorage.run(secondAttemptServerPrerenderStore, getRSCPayload, tree, ctx, isNotFound);
        reactServerStream = await _workunitasyncstorageexternal.workUnitAsyncStorage.run(secondAttemptServerPrerenderStore, _apprenderrenderutils.scheduleInSequentialTasks, ()=>{
    ...
    let clientDynamicTracking = (0, _dynamicrendering.createDynamicTrackingState)(false);
    let dynamicValidation = (0, _dynamicrendering.createDynamicValidationState)();
    function SSROnError(err, errorInfo) {
        if ((0, _dynamicrendering.isPrerenderInterruptedError)(err) || firstAttemptServerController.signal.aborted) {
    ...
    try {
        await (0, _apprenderprerenderutils.prerenderAndAbortInSequentialTasks)(async ()=>{
            _workunitasyncstorageexternal.workUnitAsyncStorage.run(firstAttemptClientPrerenderStore, prerender, /*#__PURE__*/ (0, _jsxruntime.jsx)(App, {
    ...
    if (hadException || clientDynamicTracking.syncDynamicErrorWithStack) {
        ...
        clientDynamicTracking = (0, _dynamicrendering.createDynamicTrackingState)(false);
        dynamicValidation = (0, _dynamicrendering.createDynamicValidationState)();
        ...
        try {
            await (0, _apprenderprerenderutils.prerenderAndAbortInSequentialTasks)(async ()=>{
                _workunitasyncstorageexternal.workUnitAsyncStorage.run(secondAttemptClientPrerenderStore, prerender, /*#__PURE__*/ (0, _jsxruntime.jsx)(App, {
...
async function prerenderToStream(req, res, ctx, metadata, workStore, tree) {
    ...
    try {
         ...
         */ const PRERENDER_COMPLETE = 'NEXT_PRERENDER_COMPLETE';
                ...
                const prospectiveRenderFlightSignal = prospectiveRenderFlightController.signal;
                ...
                function prospectiveRenderOnError(err) {
                ...
                firstAttemptRSCPayload, clientReferenceManifest.clientModules, {
                    ...
                    if ((process.env.NEXT_DEBUG_BUILD || process.env.__NEXT_VERBOSE_LOGGING) && !prospectiveRenderFlightController.signal.aborted && !(0, _dynamicrendering.isPrerenderInterruptedError)(err) && !(0, _hooksservercontext.isDynamicServerError)(err)) {
                        (0, _prospectiverenderutils.printDebugThrownValueForProspectiveRender)(err, workStore.route);
                    }
                });
                ...
                function finalRenderOnError(err) {
                    if ((0, _dynamicrendering.isPrerenderInterruptedError)(err)) {
                        reactServerIsDynamic = true;
                        return err.digest;
                ...
                let clientDynamicTracking = (0, _dynamicrendering.createDynamicTrackingState)(renderOpts.isDebugDynamicAccesses);
                ...
                let dynamicValidation = (0, _dynamicrendering.createDynamicValidationState)();
                function SSROnError(err, errorInfo) {
                    if ((0, _dynamicrendering.isPrerenderInterruptedError)(err) || SSRController.signal.aborted) {
                        SSRIsDynamic = true;
                        const componentStack = errorInfo.componentStack;
                ...
                const prerender = require('react-dom/static.edge').prerender;
                let { prelude, postponed } = await (0, _apprenderprerenderutils.prerenderAndAbortInSequentialTasks)(()=>_workunitasyncstorageexternal.workUnitAsyncStorage.run(ssrPrerenderStore, prerender, /*#__PURE__*/ (0, _jsxruntime.jsx)(App, {
                ...
                if (clientDynamicTracking.syncDynamicErrorWithStack) {
                    ...
                    // Reset tracking objects
                    clientDynamicTracking = (0, _dynamicrendering.createDynamicTrackingState)(renderOpts.isDebugDynamicAccesses);
                    dynamicValidation = (0, _dynamicrendering.createDynamicValidationState)();
                    SSRIsDynamic = false;
                    const finalSSRController = new AbortController();
                    const finalSSRPrerenderStore = {
                        type: 'prerender',
                        phase: 'render',
                        implicitTags: ctx.requestStore.implicitTags,
                    ...
                    ({ prelude, postponed } = await (0, _apprenderprerenderutils.prerenderAndAbortInSequentialTasks)(()=>_workunitasyncstorageexternal.workUnitAsyncStorage.run(finalSSRPrerenderStore, prerender, /*#__PURE__*/ (0, _jsxruntime.jsx)(App, {
                            reactServerStream: reactServerResult.asUnclosingStream(),
                            preinitScripts: preinitScripts,
                            clientReferenceManifest: clientReferenceManifest,
                            ServerInsertedHTMLProvider: ServerInsertedHTMLProvider,
         ...
         */ const cache = workStore.incrementalCache;
                ...
                const firstAttemptRSCPayload = await _workunitasyncstorageexternal.workUnitAsyncStorage.run(prospectiveRenderPrerenderStore, getRSCPayload, tree, ctx, res.statusCode === 404);
                let reactServerIsDynamic = false;
                function prospectiveRenderOnError1(err) {
                    if ((0, _dynamicrendering.isPrerenderInterruptedError)(err)) {
                        reactServerIsDynamic = true;
                        return err.digest;
                    } else if (prospectiveRenderFlightSignal.aborted) {
                ...
                try {
                    ...
                    firstAttemptRSCPayload, clientReferenceManifest.clientModules, {
                        onError: prospectiveRenderOnError1,
                        signal: prospectiveRenderFlightSignal
                    });
                    // When this resolves the cache has no inflight reads and we can ascertain the dynamic outcome
                    await cacheSignal.cacheReady();
                    ...
                    if (process.env.NEXT_DEBUG_BUILD && err !== abortReason && !(0, _dynamicrendering.isPrerenderInterruptedError)(err) && !(0, _hooksservercontext.isDynamicServerError)(err)) {
                        (0, _prospectiverenderutils.printDebugThrownValueForProspectiveRender)(err, workStore.route);
                    }
                }
                ...
                const finalRenderFlightController = new AbortController();
                const finalRenderFlightSignal = finalRenderFlightController.signal;
                let serverDynamicTracking = (0, _dynamicrendering.createDynamicTrackingState)(renderOpts.isDebugDynamicAccesses);
                reactServerIsDynamic = false;
                let SSRIsDynamic = false;
                const finalRenderPrerenderStore = prerenderStore = {
                    type: 'prerender',
                ...
                const finalAttemptRSCPayload = await _workunitasyncstorageexternal.workUnitAsyncStorage.run(finalRenderPrerenderStore, getRSCPayload, tree, ctx, res.statusCode === 404);
                function finalRenderOnError1(err) {
                    if ((0, _dynamicrendering.isPrerenderInterruptedError)(err)) {
                        reactServerIsDynamic = true;
                        return err.digest;
                    } else if (finalRenderFlightSignal.aborted) {
                ...
                let htmlStream;
                try {
                    htmlStream = await (0, _apprenderprerenderutils.prerenderAndAbortInSequentialTasks)(async ()=>{
                        const teedStream = _workunitasyncstorageexternal.workUnitAsyncStorage.run(// The store to scope
                        finalRenderPrerenderStore, // The function to run
                        ComponentMod.renderToReadableStream, // ... the arguments for the function to run
                        finalAttemptRSCPayload, clientReferenceManifest.clientModules, {
                            onError: finalRenderOnError1,
                            signal: finalRenderFlightSignal
                        }).tee();
                        reactServerStream = teedStream[0];
                        const rscForSSRStream = teedStream[1];
                        const prerender = require('react-dom/static.edge').prerender;
                        const { prelude } = await _workunitasyncstorageexternal.workUnitAsyncStorage.run(ssrPrerenderStore, prerender, /*#__PURE__*/ (0, _jsxruntime.jsx)(App, {
                ...
                if (clientDynamicTracking.syncDynamicErrorWithStack) {
                    ...
                    SSRIsDynamic = false;
                    reactServerIsDynamic = false;
                    serverDynamicTracking = (0, _dynamicrendering.createDynamicTrackingState)(renderOpts.isDebugDynamicAccesses);
                    const thirdRenderFlightController = new AbortController();
                    const thirdRenderPrerenderStore = prerenderStore = {
                        type: 'prerender',
                        phase: 'render',
                        implicitTags: ctx.requestStore.implicitTags,
                    ...
                    const thirdRenderRSCPayload = await _workunitasyncstorageexternal.workUnitAsyncStorage.run(finalRenderPrerenderStore, getRSCPayload, tree, ctx, res.statusCode === 404);
                    const finalSSRController = new AbortController();
                    const finalSSRPrerenderStore = {
                        type: 'prerender',
                        phase: 'render',
                    ...
                    try {
                        htmlStream = await (0, _apprenderprerenderutils.prerenderAndAbortInSequentialTasks)(()=>{
                            const teedStream = _workunitasyncstorageexternal.workUnitAsyncStorage.run(// The store to scope
                            thirdRenderPrerenderStore, // The function to run
                            ComponentMod.renderToReadableStream, // ... the arguments for the function to run
                            thirdRenderRSCPayload, clientReferenceManifest.clientModules, {
                                onError: finalRenderOnError1,
                            ...
                            const rscForSSRStream = teedStream[1];
                            const renderToReadableStream = require('react-dom/server.edge').renderToReadableStream;
                            const pendingHTMLStream = _workunitasyncstorageexternal.workUnitAsyncStorage.run(finalSSRPrerenderStore, renderToReadableStream, /*#__PURE__*/ (0, _jsxruntime.jsx)(App, {
                                reactServerStream: rscForSSRStream,
                                preinitScripts: preinitScripts,
                                clientReferenceManifest: clientReferenceManifest,
                                ServerInsertedHTMLProvider: ServerInsertedHTMLProvider,
                        ...
                        if (thirdRenderFlightController.signal.aborted || finalSSRController.signal.aborted) {
                        // We aborted with an incomplete shell. We'll handle this below with the handling
                        // for dynamic.
                        } else {
                            // We have some other kind of shell error, we want to bubble this up to be handled
                ...
                (0, _dynamicrendering.throwIfDisallowedDynamic)(workStore.route, dynamicValidation, serverDynamicTracking, clientDynamicTracking);
                if (SSRIsDynamic) {
                    const dynamicReason = (0, _dynamicrendering.getFirstDynamicReason)(clientDynamicTracking);
                    if (dynamicReason) {
                        ...
                        throw new _hooksservercontext.DynamicServerError(`Route "${workStore.route}" couldn't be rendered statically it accessed data without explicitly caching it. See more info here: https://nextjs.org/docs/messages/dynamic-io`);
                    }
                } else if (reactServerIsDynamic) {
                    const dynamicReason = (0, _dynamicrendering.getFirstDynamicReason)(serverDynamicTracking);
                    if (dynamicReason) {
                        throw new _hooksservercontext.DynamicServerError(`Route "${workStore.route}" couldn't be rendered statically because it used \`${dynamicReason}\`. See more info here: https://nextjs.org/docs/messages/dynamic-server-error`);
                    } else {
                        throw new _hooksservercontext.DynamicServerError(`Route "${workStore.route}" couldn't be rendered statically it accessed data without explicitly caching it. See more info here: https://nextjs.org/docs/messages/dynamic-io`);
