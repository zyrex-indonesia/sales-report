...
class AppRouteRouteModule extends _routemodule.RouteModule {
   ...
   */ resolve(method) {
    ...
    async handle(req, context) {
        ...
        const response = await this.actionAsyncStorage.run(actionStore, ()=>this.workUnitAsyncStorage.run(requestStore, ()=>(0, _withworkstore.withWorkStore)(this.workAsyncStorage, staticGenerationContext, async (workStore)=>{
